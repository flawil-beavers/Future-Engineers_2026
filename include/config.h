...
static_assert(
    OBSTACLE_FINAL_PARKING_PRACTICE_TURN_SIGN == 1 ||
        OBSTACLE_FINAL_PARKING_PRACTICE_TURN_SIGN == -1,
    "Parking-practice turn sign must be +1 (CCW) or -1 (CW)");
static_assert(
    OBSTACLE_FINAL_PARKING_TEST_SEGMENT_LIMIT >= 0 &&
        OBSTACLE_FINAL_PARKING_TEST_SEGMENT_LIMIT <=
            OBSTACLE_FINAL_PARKING_SEGMENT_COUNT,
    "Final-parking segment limit must be in the generated path");

constexpr auto OBSTACLE_FINAL_PARKING_REAR_OVERHANG_MM = 40.0f;
constexpr auto OBSTACLE_FINAL_PARKING_FRONT_OVERHANG_MM = 125.0f;
constexpr auto OBSTACLE_FINAL_PARKING_STRAIGHT_WIDTH_MM = 125.0f;
constexpr auto OBSTACLE_FINAL_PARKING_GAP_MM =
    OBSTACLE_FINAL_ROBOT_LENGTH_MM * OBSTACLE_PARKING_LENGTH_FACTOR;
constexpr auto OBSTACLE_FINAL_PARKING_LONGITUDINAL_CLEARANCE_MM =
    (OBSTACLE_FINAL_PARKING_GAP_MM -
     OBSTACLE_FINAL_ROBOT_LENGTH_MM) * 0.5f;
constexpr auto OBSTACLE_FINAL_PARKING_TARGET_LOCAL_X_MM =
    OBSTACLE_FINAL_PARKING_REAR_OVERHANG_MM +
    OBSTACLE_FINAL_PARKING_LONGITUDINAL_CLEARANCE_MM;
constexpr auto OBSTACLE_FINAL_PARKING_TARGET_LOCAL_Y_MM =
    OBSTACLE_PARKING_WIDTH_MM * 0.5f;

// Generated by CAD/parking_entry_swept_search.py. The capture pose has at
// least 10 mm nominal clearance beyond the 200 mm marker ends. The entry list
// is the exact kinematic reverse of the robust searched exit.
constexpr auto OBSTACLE_FINAL_PARKING_CAPTURE_LOCAL_X_MM = 270.26f;
constexpr auto OBSTACLE_FINAL_PARKING_CAPTURE_LOCAL_Y_MM = 274.60f;
constexpr auto OBSTACLE_FINAL_PARKING_CAPTURE_HEADING_DEG = 0.0f;
constexpr auto OBSTACLE_FINAL_PARKING_PRACTICE_START_X_MM = -500.0f;
constexpr auto OBSTACLE_FINAL_PARKING_PRACTICE_START_Y_MM = -1000.0f;

// The post-lap connector first uses y=-1120 mm: 110 mm nominal clearance from
// inner-row pillar movement circles and 112.5 mm from the marker ends. Only
// after the complete body has passed x=500 does it shift to the scan line.
constexpr auto OBSTACLE_FINAL_PARKING_APPROACH_LANE_Y_MM = -1120.0f;
constexpr auto OBSTACLE_FINAL_PARKING_OUTER_SHIFT_X_MM = 550.0f;
constexpr auto OBSTACLE_FINAL_PARKING_SCAN_Y_MM = -1225.40f;
constexpr auto OBSTACLE_FINAL_PARKING_SCAN_START_X_MM = 900.0f;
constexpr auto OBSTACLE_FINAL_PARKING_SCAN_ARM_X_MM = 560.0f;
constexpr auto OBSTACLE_FINAL_PARKING_SCAN_END_X_MM = 120.0f;
constexpr auto OBSTACLE_FINAL_PARKING_APPROACH_MAX_MM = 1700.0f;
constexpr auto OBSTACLE_FINAL_PARKING_SCAN_MAX_MM = 850.0f;
constexpr auto OBSTACLE_FINAL_PARKING_CAPTURE_MAX_MM = 450.0f;
constexpr uint32_t OBSTACLE_FINAL_PARKING_APPROACH_TIMEOUT_MS = 35000;
constexpr uint32_t OBSTACLE_FINAL_PARKING_SCAN_TIMEOUT_MS = 20000;
constexpr uint32_t OBSTACLE_FINAL_PARKING_CAPTURE_TIMEOUT_MS = 15000;
constexpr uint32_t OBSTACLE_FINAL_PARKING_SEGMENT_TIMEOUT_MS = 10000;

constexpr auto OBSTACLE_FINAL_PARKING_APPROACH_SPEED = 70;
constexpr auto OBSTACLE_FINAL_PARKING_SCAN_SPEED = 60;
constexpr auto OBSTACLE_FINAL_PARKING_CAPTURE_SPEED = 45;
constexpr auto OBSTACLE_FINAL_PARKING_ENTRY_SPEED = 60;
constexpr auto OBSTACLE_FINAL_PARKING_STEER_SETTLE_MS = 400;
constexpr auto OBSTACLE_FINAL_PARKING_HOLD_BRAKE_MS = 300;
constexpr auto OBSTACLE_FINAL_PARKING_LINE_LOOKAHEAD_MM = 80.0f;
constexpr auto OBSTACLE_FINAL_PARKING_LINE_HEADING_KP = 3.0f;
constexpr auto OBSTACLE_FINAL_PARKING_LINE_MAX_STEERING = 42;
constexpr auto OBSTACLE_FINAL_PARKING_LINE_MAX_ANGLE_DEG = 35.0f;
constexpr auto OBSTACLE_FINAL_PARKING_LINE_Y_TOLERANCE_MM = 5.0f;
constexpr auto OBSTACLE_FINAL_PARKING_CAPTURE_X_TOLERANCE_MM = 5.0f;
constexpr auto OBSTACLE_FINAL_PARKING_CAPTURE_HEADING_TOLERANCE_DEG = 1.0f;
constexpr auto OBSTACLE_FINAL_PARKING_FINAL_HEADING_TOLERANCE_DEG = 2.0f;
constexpr auto OBSTACLE_FINAL_PARKING_GAP_TOLERANCE_MM = 15.0f;
constexpr auto OBSTACLE_FINAL_PARKING_MAX_POSE_CORRECTION_MM = 25.0f;
constexpr auto OBSTACLE_FINAL_PARKING_FINAL_BOUNDARY_MARGIN_MM = 5.0f;
constexpr auto OBSTACLE_FINAL_PARKING_MARKER_MAX_MM = 180.0f;
constexpr auto OBSTACLE_FINAL_PARKING_WALL_MIN_MM = 190.0f;
constexpr auto OBSTACLE_FINAL_PARKING_WALL_MAX_MM = 400.0f;
constexpr auto OBSTACLE_FINAL_PARKING_WALL_RESIDUAL_MM = 25.0f;
constexpr auto OBSTACLE_FINAL_PARKING_CLASS_CONFIRM_FRAMES = 2;
